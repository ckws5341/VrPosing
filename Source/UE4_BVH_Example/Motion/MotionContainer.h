...
public:
	...
	const Motion* getMotion(int i) const;
	const Motion *getMotion(std::string name) const;
...
void SelectKeyFramesByKineticEnergy(const MotionContainer *mc , MotionKeyFrames &out_key_frames, int smooth_times=3);
