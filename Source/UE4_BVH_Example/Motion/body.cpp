...
const std::set<JointTag>& 
ml::GetEssentialJointTagSet()
{
...
bool 
ml::VarifyEssentialJointTags(const Body *body)
{
	// Assign the values at the first time only.
	if ( g_essential_joint_tags.empty() )
	{
...
void ml::Body::SetPredefinedTagMap(std::string map_name)
{
	...
	else if ( map_name.compare("woody_actor") ==  0 )
	{
		m_joint_tag_map[ml::JointTag::PELVIS] = 0;

		m_joint_tag_map[ml::JointTag::SPINE]      = m_jointMap["spine_2"];
		m_joint_tag_map[ml::JointTag::SPINE1]     = -1;
		m_joint_tag_map[ml::JointTag::SPINE2]     = -1;
		m_joint_tag_map[ml::JointTag::CHEST]      = m_jointMap["chest"];
		m_joint_tag_map[ml::JointTag::NECK]       = -1;
		m_joint_tag_map[ml::JointTag::HEAD]       = m_jointMap["neck"];
		m_joint_tag_map[ml::JointTag::HEAD_END]   = -1;//m_jointMap["HEadEnd"];

		m_joint_tag_map[ml::JointTag::L_HIP]      = m_jointMap["upper_left_leg"];
		m_joint_tag_map[ml::JointTag::L_KNEE]     = m_jointMap["lower_left_leg"];
		m_joint_tag_map[ml::JointTag::L_ANKLE]    = m_jointMap["left_foot"];
		m_joint_tag_map[ml::JointTag::L_FOOT]     = m_jointMap["left_toe"];
		m_joint_tag_map[ml::JointTag::L_TOE]      = -1;
		m_joint_tag_map[ml::JointTag::L_TOE_END]  = -1;//m_jointMap["LeftToesEnd"];

		m_joint_tag_map[ml::JointTag::R_HIP]      = m_jointMap["upper_right_leg"];
		m_joint_tag_map[ml::JointTag::R_KNEE]     = m_jointMap["lower_right_leg"];
		m_joint_tag_map[ml::JointTag::R_ANKLE]    = m_jointMap["right_foot"];
		m_joint_tag_map[ml::JointTag::R_FOOT]     = m_jointMap["right_toe"];
		m_joint_tag_map[ml::JointTag::R_TOE]      = -1;
		m_joint_tag_map[ml::JointTag::R_TOE_END]  = -1;//m_jointMap["RightToesEnd"];

		m_joint_tag_map[ml::JointTag::L_CLAVICLE] = m_jointMap["left_shoulder"];
		m_joint_tag_map[ml::JointTag::L_SHOULDER] = m_jointMap["upper_left_arm"];
		m_joint_tag_map[ml::JointTag::L_ELBOW]    = m_jointMap["lower_left_arm"];
		m_joint_tag_map[ml::JointTag::L_WRIST]    = m_jointMap["left_palm"];
		m_joint_tag_map[ml::JointTag::L_PALM]     = -1;
		m_joint_tag_map[ml::JointTag::L_PALM_END] = -1;//m_jointMap["LeftHandEnd"];

		m_joint_tag_map[ml::JointTag::R_CLAVICLE] = m_jointMap["right_shoulder"];
		m_joint_tag_map[ml::JointTag::R_SHOULDER] = m_jointMap["upper_right_arm"];
		m_joint_tag_map[ml::JointTag::R_ELBOW]    = m_jointMap["lower_right_arm"];
		m_joint_tag_map[ml::JointTag::R_WRIST]    = m_jointMap["right_palm"];
		m_joint_tag_map[ml::JointTag::R_PALM]     = -1;
		m_joint_tag_map[ml::JointTag::R_PALM_END] = -1;//m_jointMap["RightHandEnd"];
	}
